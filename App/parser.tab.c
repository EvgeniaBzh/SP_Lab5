...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_COUT = 10,                      /* COUT  */
  YYSYMBOL_SETW = 11,                      /* SETW  */
...
static const char *const yytname[] =
{
  ...
  "FLOAT", "RETURN", "USING", "NAMESPACE", "COUT", "SETW", "INCLUDE",
  "'+'", "'-'", "'*'", "'/'", "'('", "')'", "'{'", "'}'", "';'", "'='",
...
{
      -4,   -17,   -17,     3,    -4,   -17,     4,   -17,   -17,    -3,
      17,    15,    52,    18,    19,     7,     7,    -1,   -17,    14,
      26,   -17,   -17,     7,    12,    16,   -17,   -17,     7,     7,
      38,     7,     7,     7,     7,   -17,   -17,    25,    29,   -17,
       5,     5,   -17,   -17,   -17,   -17
};
...
{
      25,     1,     2,     7,    13,    14,    15,    30,     9,    16,
      21,    22,    37,    38,    10,    40,    41,    42,    43,    26,
      33,    34,    19,    20,    23,    31,    32,    33,    34,    31,
      32,    33,    34,    35,    12,    11,    28,    36,    31,    32,
      33,    34,    31,    32,    33,    34,    44,     8,    29,    27,
      45,    31,    32,    33,    34,     0,    39,    13,    14,    15,
       0,     0,    16
};

static const yytype_int8 yycheck[] =
{
      16,     5,     6,     0,     5,     6,     7,    23,     4,    10,
       3,     4,    28,    29,    17,    31,    32,    33,    34,    20,
      15,    16,     4,     4,    17,    13,    14,    15,    16,    13,
      14,    15,    16,    21,    19,    18,    22,    21,    13,    14,
      15,    16,    13,    14,    15,    16,    21,     4,    22,    17,
      21,    13,    14,    15,    16,    -1,    18,     5,     6,     7,
      -1,    -1,    10
};
...
{
       0,     5,     6,    24,    25,    26,    27,     0,    26,     4,
      17,    18,    19,     5,     6,     7,    10,    28,    29,     4,
       4,     3,     4,    17,    30,    30,    20,    29,    22,    22,
      30,    13,    14,    15,    16,    21,    21,    30,    30,    18,
      30,    30,    30,    30,    21,    21
};
...
#line 33 "parser.y"
                             { printf("Parsed multiple functions\n"); }
#line 1129 "parser.tab.c"
    break;

  case 5: /* function: type ID '(' ')' '{' statement_list '}'  */
#line 37 "parser.y"
...
#line 46 "parser.y"
              { printf("Parsed single statement\n"); }
...
#line 1165 "parser.tab.c"
  ...
  case 11: /* statement: INT ID '=' expression ';'  */
#line 52 "parser.y"
                                { printf("Parsed variable declaration\n"); }
#line 1171 "parser.tab.c"
    break;

  case 12: /* statement: FLOAT ID '=' expression ';'  */
#line 53 "parser.y"
                                  { printf("Parsed float variable declaration\n"); }
#line 1177 "parser.tab.c"
    break;

  case 13: /* statement: COUT expression ';'  */
#line 54 "parser.y"
                          { printf("Parsed cout statement\n"); }
